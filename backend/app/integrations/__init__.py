...
class AgentflowConfig:
    ...
    def _init(self, env: str):
        ...
        if HAS_CONFIG_LOADER and ConfigLoader is not None:
            try:
                ...
                warnings.warn("agent-config-loader 加载失败，回退到 settings")
                self._config = None
        else:
            self._config = None
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        if (
            ...
            and not isinstance(self._config, dict)
        ):
    ...
    def database_url(self) -> str:
        val = self.get("DATABASE_URL")
        return val or "sqlite+aiosqlite:///./agentflow.db"

    @property
    def redis_url(self) -> str:
        val = self.get("REDIS_URL")
...
class AgentflowTracer:
    ...
    def _init(self):
        ...
        if HAS_OBSERVABILITY and Tracer is not None:
            try:
                self._tracer = Tracer(
                ...
                warnings.warn("agent-observability 初始化失败，追踪已禁用")
    ...
    def start_span(
        ...
        **kwargs,
        ...
        """开始一个追踪 span"""
        if not HAS_OBSERVABILITY or self._tracer is None:
            return None
    ...
    def end_span(
        ...
        try:
            if token_usage and TokenUsage is not None:
    ...
    def trace_chat(self, func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if span_id and hasattr(result, "usage"):
                    self.end_span(
                        span_id,
                        token_usage={
                            "prompt": getattr(
